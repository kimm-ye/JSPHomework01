...
<form id="AllWrap" name="findFrm" >
    ...
    <div id="IdBox" class="">
        <table align="center" id="InputTable">
            ...
            <tr id="item01" style="display:none;">
                ...
                <td>
                    <input type="text" name="findId" style="width:200px;">
                </td>
            </tr>
            <tr id="item02">
                <th><span class="bullet">&gt;</span><strong>이 름</strong></th>
                <td>
                    <input type="text" name="findName" style="width:200px;">
                </td>
            </tr>
            <!-- <tr id="item03">
                <th>
    ...
    <div style="margin-top:20px;">
        <input type="submit" value="아이디 찾기 &gt;" id="idBtn" onclick="searchId()" >
    </div>
    <div style="margin-top:20px;"  >
        <input type="submit" value="비밀번호 찾기 &gt;" style="display:none;" id="pwBtn" onclick="searchPw()">
    </div>
</form>
</body>
</html>